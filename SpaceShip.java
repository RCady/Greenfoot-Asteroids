...
public class SpaceShip extends Player
{
    ...
    public void gunBehavior()
    {
        ...
        if (!Greenfoot.isKeyDown("space") && numberOfProjectiles < 15)
        {
            isDown = false;
        }
    }
    ...
    public void movement()
    {
        ...
        if (Greenfoot.isKeyDown("left") ) //R8
        {
           turn(-4);
        }

        if (Greenfoot.isKeyDown("right") ) //R8
        {
           turn(4);
        }
